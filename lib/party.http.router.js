 ...
 *
 * @apiDescription A representation of an entity describing information about a
 ...
 * @apiSuccess {String} [party = undefined] Top party(i.e company,
 ...
 * @apiSuccess {Point} [location=undefined] A geo-location cetroid of a party
 * operational boundaries.
 * @apiSuccess {MultiPolygon} [boundary=undefined] Party geo-operational boundaries.
 ...
 * @apiSuccess {String} [data.party = undefined] Top party(i.e company,
 * organization etc) under which a party is derived(or member, part of etc).
 ...
 * a party.
 * @apiSuccess {Point} [data.location=undefined] A geo-location cetroid of a party
 * operational boundaries.
 * @apiSuccess {MultiPolygon} [data.boundary=undefined] Party geo-operational
 * boundaries.
